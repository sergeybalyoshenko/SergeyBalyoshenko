...
//Write your function so that in the case a string or a number is passed in as the data , you will return the data
// in reverse order. If the data is any other type, return it as it is.
